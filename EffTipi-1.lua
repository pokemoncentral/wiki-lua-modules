...
Modulo dati contenente i valori di efficacia di gen 1.
...
et.ghiaccio = {normale = 1, fuoco = 1, acqua = 0.5, elettro = 1, erba = 2, ghiaccio = 0.5, lotta = 1, veleno = 1, terra = 2,
...
et.coleottero = {normale = 1, fuoco = 0.5, acqua = 1, elettro = 1, erba = 2, ghiaccio = 1, lotta = 0.5, veleno = 2, terra = 1,
