...
Modulo dati contenente i valori di efficacia da gen 6 in avanti.
...
et.folletto = {normale = 1, fuoco = 0.5, acqua = 1, elettro = 1, erba = 1, ghiaccio = 1, lotta = 2, veleno = 0.5, terra = 1,
