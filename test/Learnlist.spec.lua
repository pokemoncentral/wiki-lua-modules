...
-- print(ll.levelLua('arcanine', 7))
-- print(ll.preevoLua('arcanine', 7))
-- print(ll.tmLua('bulbasaur', 7))
-- print(ll.breedLua('bulbasaur', 7))
-- print(ll.breedLua('geodude', 6))
-- print(ll.preevoLua('venusaur', 7))
-- print(ll.preevoLua('huntail', 7))
-- print(ll.tutorLua('bulbasaur', 7))
-- print(ll.levelLua('mr. mime', 7))
-- print(ll.tmLua('mr. mime', 7))
-- print(ll.breedLua('mr. mime', 7))
-- print(ll.preevoLua('mr. mime', 7))
-- print(ll.breedLua('nosepass', 7))
print(ll.levelLua('poipole', 7))
print(ll.breedLua('poipole', 7))
-- print(ll.tutorLua('mr. mime', 7))
-- for gen=6,7 do
