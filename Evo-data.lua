...
createMega("skarmory", 227, "Skarmorite")
...
createMega("froslass", 478, "Froslassite")
createMega("emboar", 500, "Emboarite")
createMega("excadrill", 530, "Excadrillite")
createMega("audino", 531, "Audinite")
createMega("scolipede", 545, "Scolipedite")
createMega("scrafty", 560, "Scraftite")
createMega("eelektross", 604, "Eelektrossite")
createMega("chandelure", 609, "Chandelurite")
createMega("chesnaught", 652, "Chesnaughtite")
createMega("delphox", 655, "Delphoxite")
createMega("greninja", 658, "Greninjite")
createMega("pyroar", 668, "Pyroarite")
createMega("floette", 670, "Floettite")
createMega("malamar", 687, "Malamarite")
createMega("barbaracle", 689, "Barbaraclite")
createMega("dragalge", 691, "Dragalgite")
createMega("hawlucha", 701, "Hawluchite")
createMega("zygarde", 718, "Zygardite")
createMega("diancie", 719, "Diancite")
createMega("drampa", 780, "Drampite")
createMega("falinks", 870, "Falinksite")
